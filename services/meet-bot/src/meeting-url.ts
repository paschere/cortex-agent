...
/**
 * Meet, Teams o Zoom. Devuelve null si el enlace no es de una de las tres.
 * Copia el contrato de packages/agent-tools/src/meetings/meeting-url.ts:
 * la imagen del bot no incluye ese paquete.
 */
