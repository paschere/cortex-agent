...
export interface CatalogTool {
  ...
  /** Risk once addressed outside Zipdev, when it differs from the baseline. */
    ...
    <div className="flex flex-col gap-4">
      ...
      <Panel className="flex flex-col gap-3 p-4">
        ...
        <p className="text-[11px] leading-relaxed text-ink-faint">
          ...
          recipient outside Zipdev, or a bulk export all raise it, and only the genuinely dangerous
          combinations are refused outright. Everything else runs and is recorded.
        </p>
      </Panel>
                            ...
                            <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
                              <Badge
                                ...
                                title={[
                                  ...
                                  t.outboundRiskLevel
                                    ? `Rises to ${RISK_LABEL[t.outboundRiskLevel].toLowerCase()} when addressed outside Zipdev`
                                    : null,
                                ]
                                  .filter(Boolean)
                                  .join(' — ')}
                              ...
                              {t.canLeaveCompany ? (
                                <Badge
                                  ...
                                  title={
                                    t.outboundRiskLevel
                                      ? `Scored ${RISK_LABEL[t.outboundRiskLevel].toLowerCase()} once it is addressed to someone outside Zipdev`
                                      : 'Content reaches people outside Zipdev'
                                  }
                                >
