      ...
      <div>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <input
            ...
            className="tabular h-9 w-full max-w-[280px] rounded-card border border-border bg-surface px-3 text-sm text-ink placeholder:text-ink-faint focus:border-primary/40 disabled:opacity-60"
          />
        ...
        {message && (
          <p
            className={
              message.tone === 'ok'
                ? 'mt-2.5 rounded-card border border-emerald/30 bg-emerald-soft px-3 py-2 text-xs leading-relaxed text-ink'
                : message.tone === 'warn'
                  ? 'mt-2.5 rounded-card border border-amber/30 bg-amber-soft px-3 py-2 text-xs leading-relaxed text-ink'
                  : 'mt-2.5 rounded-card border border-rose/30 bg-rose-soft px-3 py-2 text-xs leading-relaxed text-ink'
            }
          >
            {message.text}
          </p>
          ...
          {meetings.map((m) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                {m.status === 'failed' && (
                  <div className="mt-1 text-micro text-rose">
