...
export function SettingsForm({
  ...
  async function save() {
    ...
    try {
      ...
      const json = (await res.json()) as { preferences?: PreferencesView; error?: string };
      if (!res.ok) {
        setStatus({ kind: 'error', message: json.error ?? 'Could not save your settings.' });
        return;
      }
        ...
        <div className="mt-4 rounded-[12px] border border-border bg-surface-2 p-4">
          ...
          <ul className="mt-2.5 space-y-1.5 text-[12.5px] leading-relaxed text-ink-muted">
            ...
            <li>
              ...
              condensed on Zipdev&apos;s servers into the digest you receive. The mail itself is
              never stored, never added to the Knowledge Base, and never handed to the assistant you
              chat with.
            </li>
            <li>
        ...
        <div className="mt-3 space-y-4">
          <div className="rounded-[12px] border border-border p-4">
            ...
            <div className="mt-2 flex items-center gap-1.5 text-[12px] text-ink-faint">
              ...
              This is the address on your Zipdev account and cannot be changed here.
            </div>
          </div>
