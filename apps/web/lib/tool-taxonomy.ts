...
export const FAMILY_META: Record<string, FamilyMeta> = {
  recruit: {
    name: "Recruiting",
    blurb:
      "The ATS — requisitions, candidates, matching, scoring and client presentations.",
    tone: "primary",
    icon: "UserSearch",
  },
  workable: {
  ...
  presentations: {
    name: "Presentations",
    blurb:
      "Candidate PDFs prepared for clients, and the history of what was already sent.",
    tone: "primary",
    icon: "FileText",
  },
  people: {
  ...
  hubspot: {
    name: "HubSpot",
    blurb:
      "The CRM — companies, contacts, deals, pipeline health and activity logging.",
    tone: "amber",
    icon: "Building2",
  },
  growth: {
    name: "Growth Signals",
    blurb:
      "Buying signals from the market and the decision-makers behind them.",
    tone: "amber",
    icon: "TrendingUp",
  },
  apollo: {
  ...
  sales: {
    name: "Sales",
    blurb:
      "Client-facing proposal drafting, grounded in CRM and Knowledge Base context.",
    tone: "amber",
    icon: "Handshake",
  },
  bamboo: {
  ...
  meetings: {
    name: "Meetings",
    blurb:
      "Recorded transcripts and the briefings Cortex prepares before a call.",
    tone: "sky",
    icon: "Mic",
  },
  inbox: {
    name: "Inbox",
    blurb:
      "The daily priority list and digests Cortex assembles from everything it can see.",
    tone: "sky",
    icon: "Inbox",
  },
  gmail: {
    name: "Gmail",
    blurb:
      "Read the mailbox, search threads, prepare drafts and send approved ones.",
    tone: "rose",
    icon: "Mail",
  },
  gcal: {
    ...
    blurb:
      "Upcoming meetings, availability and event creation with invitations.",
    tone: "sky",
    icon: "CalendarDays",
  },
  gdrive: {
  ...
  github: {
    name: "GitHub",
    blurb:
      "Repositories, issues, pull requests and delivery metrics for engineering.",
    tone: "sky",
    icon: "GitBranch",
  },
  linear: {
    name: "Linear",
    blurb:
      "Issues, projects, cycles and team workload for the engineering roadmap.",
    tone: "sky",
    icon: "SquareKanban",
  },
  slack: {
    name: "Slack",
    blurb:
      "Post messages into channels — including channels shared with clients.",
    tone: "amber",
    icon: "MessageSquare",
  },
  chat: {
  ...
  schedule: {
    name: "Routines",
    blurb:
      "Unattended jobs that keep running on a schedule until someone pauses them.",
    tone: "primary",
    icon: "AlarmClock",
  },
  vehicles: {
  ...
  web: {
    name: "Web",
    blurb:
      "Public search and page scraping — the only family that touches nothing internal.",
    tone: "emerald",
    icon: "Globe",
  },
  security: {
    name: "Security",
    blurb:
      "Read-only introspection over the guardrail's own decisions and recent events.",
    tone: "rose",
    icon: "ShieldCheck",
  },
  cortex: {
