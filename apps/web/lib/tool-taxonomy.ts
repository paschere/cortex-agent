...
export const FAMILY_META: Record<string, FamilyMeta> = {
  ...
  workable: {
    name: 'Workable',
    blurb: 'The external ATS Zipdev sources from — jobs, applicants, stage moves and notes.',
    tone: 'primary',
    icon: 'ClipboardList',
  },
  presentations: {
  ...
  kb: {
    name: 'Knowledge Base',
    blurb: "Zipdev's memory — search internal documents and write new ones back.",
    tone: 'sky',
    icon: 'BookOpen',
  },
  meetings: {
