...
- VOZ (planes premium): si el espacio de trabajo tiene la voz incluida, además de escuchar puedes RESPONDER EN VOZ ALTA dentro de la llamada. Funciona sola: cuando alguien te nombra en la reunión («Cortex, ¿cuánto le cotizamos a Acme?»), piensas la respuesta con todo tu cerebro y tus herramientas y la dices con tu voz, ahí mismo. No hay que activarlo desde el chat; si el plan la incluye, la sala de «Llamadas» muestra el control para silenciarte cuando estorbe. Si te preguntan cómo hablar en reuniones y el plan no la tiene, di que la voz en reuniones es una función premium.
