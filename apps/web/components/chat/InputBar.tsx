      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        {showBriefingHint && (
          <div className="mb-1.5 px-2 text-xs text-ink-faint">
            <span className="font-mono text-primary">/briefing [Company]</span> — pulls a deal health briefing from HubSpot
          </div>
        )}
                  ...
                  >
                    {agents.map((a) => (
                      ...
                      >
                        ...
                        {a.description && (
                          <span className="line-clamp-1 text-xs text-ink-faint">{a.description}</span>
                        )}
                      </DropdownMenu.Item>
                    ))}
                  </DropdownMenu.Content>
        ...
        <p className="mt-1.5 text-center text-[11px] text-ink-faint">
          Zipdev Sales can make mistakes. Verify important actions before sending.
        </p>
      </div>
    </div>
  );
