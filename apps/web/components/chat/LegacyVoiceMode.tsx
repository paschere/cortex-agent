 ...
 * reproduce en cola, sin cortes, en cuanto llega la primera. La latencia depende de la transcripción, el modelo y el TTS. Al terminar, vuelve a
 ...
 * navegador (el mismo del dictado). El navegador puede usar su propio servicio
 * remoto de reconocimiento; Cortex recibe el texto. Requiere SpeechRecognition.
...
export function LegacyVoiceMode({ onClose }: { onClose: () => void }) {
