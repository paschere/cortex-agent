...
/**
 * One person's career at Zipdev: every client move, title change, manager
...
const jobChangeSchema = z.object({
  ...
  /** BambooHR's "department" — at Zipdev, the client the person was placed with. */
