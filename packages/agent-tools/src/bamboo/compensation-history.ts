 ...
 * `compensation` (what the company pays) and the custom `customBillRate1` (what
 * the company charges). Answering "when was her last raise, and did we reprice the
...
const changeSchema = z.object({
  ...
  /** 'pay' — what the company pays them. 'bill' — what it charges the client. */
