...
export const pipelineKanban = registerTool({
  ...
  description:
    ...
    'PROVENANCE: stages and decisions come from the Zipdev matcher DB, recorded from the client\'s own review in the client portal — they are client feedback, never AI output. Cite the freshness from meta.fetchedAt, and relay meta.dataQuality: "no sentiment recorded" means no feedback yet, not negative feedback.',
