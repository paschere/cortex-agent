...
export const getPresentation = registerTool({
  ...
  description:
    ...
    'PROVENANCE: presentations are stored in the Zipdev matcher DB; `createdBy` / `lastEditedBy` tell you whether the text was AI-written or edited by a human, and `updatedAt` how fresh it is. Say which when you describe it.',
