...
// ---------------------------------------------------------------------------
//
// SE MUDÓ A `../mail/audience.ts` sin cambiar nada, porque la ingesta de Gmail
// necesita el mismo juicio y esta regla —qué correspondencia puede entrar a un
// espacio compartido— no puede existir en dos sitios. Se re-exporta desde aquí
// para que todo lo que ya la importaba de este módulo siga funcionando.
export {
  type ThreadAudience,
  domainOf,
  classifyAudience,
