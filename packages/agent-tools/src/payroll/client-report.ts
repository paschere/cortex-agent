...
export const payrollClientReport = registerTool({
  ...
  description:
    'The complete picture of one client account in a single call: every person assigned to that client by name with their role, seniority in the account and monthly cost, the total monthly and annualized cost, the expenses charged against that client, and the recent cost trend. ' +
    ...
    `Combine with payroll.cost_projection for a forward-looking model. ${COMP_SENSITIVITY_NOTE}`,
