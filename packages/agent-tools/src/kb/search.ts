...
export const kbSearch = registerTool({
  ...
  description:
    ...
    'Use this to look one specific thing up. When you are about to WRITE something that should reflect what Zipdev knows — a proposal, a client email, a rate answer — use kb.context instead: it runs several angles at once and hands back grouped, citable sources. Do not call this three times in a row to do that by hand.',
