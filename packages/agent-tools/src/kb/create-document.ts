...
export const kbCreateDocument = registerTool({
  ...
  inputSchema: z.object({
    ...
    space: z
      ...
      .optional()
      .describe(
        "Name of the space to save into — omit for the person's own notes",
      ),
  }),
