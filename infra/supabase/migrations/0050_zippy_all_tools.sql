-- Zippy holds every tool family, including the ones not written yet.
--
...
-- maintenance at all.
--
-- WHAT THIS DOES NOT DO. It does not widen what Zippy may *execute*. This
...
-- Scoped to zippy on purpose: the archived sales and recruiting agents keep
