-- Per-user opt-ins for anything Zippy does on someone's behalf without being
-- asked in the moment — reading their mailbox, messaging them proactively.
--
-- Explicitly opt-in: nothing here defaults to on. Zippy reading a teammate's
...
create table if not exists public.user_preferences (
  ...
  -- Daily inbox digest: Zippy reads the person's recent mail server-side and
  ...
  -- Free-form guidance the person gives Zippy about what matters to them
